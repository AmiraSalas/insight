        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-8 py-12">
          ...
          <Card className="p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-3xl font-bold text-primary" data-testid="text-tips-title">
                {isLoading ? "Loading..." : siteContent?.tipsTitle || "Scholarship Tips & How to Apply"}
              </h1>
            </div>
            ...
            {isLoading ? (
              ...
              <div className="prose prose-sm max-w-none" data-testid="text-tips-content">
                {renderMarkdown(siteContent?.tipsContent || "")}
              </div>
            )}

            {siteContent?.lastUpdated && (
              <p className="mt-8 text-sm text-muted-foreground border-t pt-4" data-testid="text-tips-updated">
